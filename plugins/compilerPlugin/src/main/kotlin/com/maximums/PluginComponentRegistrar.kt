...
class PluginComponentRegistrar : CompilerPluginRegistrar() {
    ...
    override fun ExtensionStorage.registerExtensions(configuration: CompilerConfiguration) {
        configuration.get(LogKCPCommandLineProcessor.IR_DUMP_FILE_PATH_KEY)?.let { file ->
            ...
            val fileMsgCollector = FileMessageCollector(file, messageCollector)

            IrGenerationExtension.registerExtension(extension = LogKCPIrGenerationExtension(fileMsgCollector))
        }
    }
}
